...
res1 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res2 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res3 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res4 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res5 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res6 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res7 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res8 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res9 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res10 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
res11 = Reservation.create(users_id: u1.id, movie_rights_id: mv1.id)
